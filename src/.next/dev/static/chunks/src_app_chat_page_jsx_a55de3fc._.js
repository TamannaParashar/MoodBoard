...
function ChatPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ChatPage.useEffect": ()=>{
            ...
            // Fetch chat history
            fetch(`/api/userChat/history?roomId=${roomId}`).then({
                "ChatPage.useEffect": (res)=>res.json()
            }["ChatPage.useEffect"]).then({
                "ChatPage.useEffect": (data)=>setMessages(data.messages || [])
            }["ChatPage.useEffect"]);
            return ({
                "ChatPage.useEffect": ()=>socket.disconnect()
            })["ChatPage.useEffect"];
        }
    }["ChatPage.useEffect"], [
        roomId
    ...
    if (!roomId || !from || !to) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "min-h-screen flex items-center justify-center text-green",
            children: "Missing chat parameters"
        }, void 0, false, {
...
_s(ChatPage, "6qwd8dcjO+YjrmiIA9MuOu+2MWM=", false, function() {
    return [
...
//# sourceMappingURL=src_app_chat_page_jsx_a55de3fc._.js.map